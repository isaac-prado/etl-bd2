...
class Ingrediente(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True) # MUDANÇA: SERIAL -> autoincrement=True
    nome = Column(String(100), nullable=False, unique=True)    # Nome continua UNIQUE
